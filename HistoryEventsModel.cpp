...
HistoricalEventsModel::HistoricalEventsModel()
{
    ...
    for(int i = 0; i <= 23; i++) {
        ...
        file.close();
        mHistoryEvents.append(HistoricalEvent(html, dateForEvent(i), "audio" + QString::number(i)));
    }
...
double HistoricalEventsModel::dateForEvent(const int i) {
    switch (i) {
        ...
        case 15: return 4750.8;
        case 16: return 4800.81;
        case 17: return 4850.84;
        case 18: return 4900.86;
        case 19: return 4950.88;
        case 20: return 5000.90;
        case 21: return 5050.92;
        case 22: return 5100.94;
        case 23: return 5150;
    }
    return 5150;
}
...
QVariant HistoricalEventsModel::data(const QModelIndex &index, int role) const
{
    ...
    case AudioRole:
        return mHistoryEvents[index.row()].audioFile;
    default:
        return QVariant();
        break;
    }
